...
public class AgentStateInicio {
	...
	public static void main(String[] args) throws Exception {
		...
		JPanel contenedorBotonesInicio = panelBotonesInicio(); //panel Botones de Inicio (inicio sesion - registrarse - salir)
		...
		contenedorSuperior.add(contenedorBotonesInicio, BorderLayout.EAST); //colocá panel Botones Inicio dentro del panel superior a la derecha "east"
...
// panel CENTRAL completo
	private static JPanel panelCentral() {
			...
			lblNewLabel_1.setIcon(new ImageIcon("C:\\Users\\Pablo Sergio Petito\\Documents\\Inmobiliaria\\petito\\Papeleria\\logoPetito150x75png.png"));
